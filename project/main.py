...
def cliente_valido():
    ...
    cliente = Cliente(123, "Anthony", "71 98472 - 9798", "anthony@gmail.com", endereco_cliente, Sexo.MASCULINO, EstadoCivil.SOLTEIRO, "25/03/2007", "123_PA")
    print(cliente)

def ps_valido():
    limpar()
    endereco_ps = Endereco("Avenida Paulista", "1578", "9º Andar", "01310-200", "São Paulo", UnidadeFederativa.SAO_PAULO)
    ps = PrestacaoServico(321, "Bruno", "4002 - 8922", "bruno123@gmail.com", endereco_ps, "12.123.123/000", "SEFAZ", "25/03/2007", "Pendente...")
    print(ps)
